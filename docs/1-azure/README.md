...
- Click the 'dcos' template in the results listing to start provisioning compute resources.
- <i>note: If you do not see a 'dcos' template please see [Pre-requisite 2: Configure an Azure Template](template/README.md).</i><br>
<img src="03.png">
