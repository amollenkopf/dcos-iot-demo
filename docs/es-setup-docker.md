...
<b>Step 3:</b> Login to <a href="https://hub.docker.com/">Docker Hub</a> with your credentials so that we can ultimately push the Docker image to your public repository.<br>
...
<b>Step 5:</b> Review the <a href="../es-docker/Dockerfile">dcos-iot-demo/es-docker/Dockerfile</a><br>
