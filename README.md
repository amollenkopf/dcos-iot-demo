...
1. <a href="docs/acs-setup.md">Getting a DC/OS cluster running on the cloud provider of your choice.</a><br>
...
5. <a href="docs/marathon-lb-setup.md">Schedule marathon-lb to run on public agents</a><br>
6. <a href="docs/azure-ports-setup.md">Open up Azure ports</a><br>
7. <a href="docs/map-setup.md">Schedule the map</a><br>
