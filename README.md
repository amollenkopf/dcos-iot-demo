...
1. <a href="docs/acs-setup.md">Establish a DC/OS cluster on the cloud provider of your choice</a><br>
2. <a href="docs/kafka-setup.md">Schedule Kafka brokers</a><br>
3. <a href="docs/es-setup.md">Schedule an Elasticsearch cluster</a><br>
4. <a href="docs/marathon-lb-setup.md">Schedule marathon-lb to run on public agents</a><br>
5. <a href="docs/azure-ports-setup.md">Open up Azure ports</a><br>
6. <a href="docs/map-setup.md">Schedule the map</a><br>
